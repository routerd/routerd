...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DNSForward) DeepCopyInto(out *DNSForward) {
	*out = *in
	if in.To != nil {
		in, out := &in.To, &out.To
		*out = make([]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DNSForward.
func (in *DNSForward) DeepCopy() *DNSForward {
	if in == nil {
		return nil
	}
	out := new(DNSForward)
...
func (in *DNSServerSpec) DeepCopyInto(out *DNSServerSpec) {
	*out = *in
	...
	in.ZoneSelector.DeepCopyInto(&out.ZoneSelector)
	in.RecordSetSelector.DeepCopyInto(&out.RecordSetSelector)
}
